...
bool YoloV7::hasGPU = true;
bool YoloV7::toUseGPU = true;
YoloV7 *YoloV7::detector = nullptr;

YoloV7::YoloV7(AAssetManager *assetManager, const char *paramFilePath, const char *binFilePath,
           bool useGPU) {
...
std::vector<BoxInfo>
YoloV7::detect(JNIEnv *env, jobject image, float threshold, float nms_threshold) {
...
std::vector<BoxInfo>
YoloV7::decode_infer(ncnn::Mat &data, const yolocv::YoloSize &frame_size, int net_size,
