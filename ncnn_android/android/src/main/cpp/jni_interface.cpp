...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_sportsvisio_SimplePose_detect(JNIEnv *env, jclass clazz, jobject image) {
    auto result = SimplePose::detector->detect(env, image);

    auto box_cls = env->FindClass("com/sportsvisio/KeyPoint");
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_sportsvisio_Yolact_detect(JNIEnv *env, jclass clazz, jobject image) {
    auto result = Yolact::detector->detect_yolact(env, image);

    auto yolact_mask = env->FindClass("com/sportsvisio/YolactMask");
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_sportsvisio_ocr_ChineseOCRLite_detect(JNIEnv *env, jclass clazz, jobject bitmap, jint short_size) {
...
//    LOGD("jni ocr ocrresult[0][0]:%s", ocrResult[0].pre_res[0].c_str());
    ...
    auto ocr_result = env->FindClass("com/sportsvisio/ocr/OCRResult");
...
Java_com_sportsvisio_ENet_detect(JNIEnv *env, jclass, jobject image) {
...
extern "C" JNIEXPORT jfloatArray JNICALL
Java_com_sportsvisio_MbnSeg_detect(JNIEnv *env, jclass, jobject image) {
...
extern "C" JNIEXPORT jfloatArray JNICALL
Java_com_sportsvisio_MbnFCN_detect(JNIEnv *env, jclass, jobject image) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_sportsvisio_FaceLandmark_detect(JNIEnv *env, jclass clazz, jobject image) {
    auto result = FaceLandmark::detector->detect(env, image);

    auto box_cls = env->FindClass("com/sportsvisio/FaceKeyPoint");
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_sportsvisio_LightOpenPose_detect(JNIEnv *env, jclass clazz, jobject image) {
    auto poses = LightOpenPose::detector->detect(env, image);

    auto box_cls = env->FindClass("com/sportsvisio/OpenPoseKeyPoint");
